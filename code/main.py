...
def handle_buscar_cpf(cpf, municipio_selecionado_valor, estado):
    ...
    try:
        ...
        print(f"Valor de d_cd_ibge em dados_pessoa_global: {safe_get(dados_pessoa_global, 'd_cd_ibge')}")
        print(f"Tipo de d_cd_ibge: {type(safe_get(dados_pessoa_global, 'd_cd_ibge'))}")
        # ----------------------------------------
